...
class app
{
  public:
    ...
    void recreate_window(sf::Uint32 style, const glm::vec2 &center, const glm::vec2 &size,
  ...
  private:
    ...
    sf::Time m_phys_time, m_draw_time, m_raw_phys_time, m_raw_draw_time;

    float m_time_smoothness = 0.f;
    sf::Color m_entity_color = PPX_DEFAULT_ENTITY_COLOR, m_springs_color = PPX_DEFAULT_JOINT_COLOR,
